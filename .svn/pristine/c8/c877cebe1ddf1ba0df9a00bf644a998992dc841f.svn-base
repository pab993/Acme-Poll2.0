...
public class FolderService {
	...
	public Double eighthQuery() {
		Double res = folderRepository.eighthQuery();
		return res;
	}

	public Double ninethQuery() {
		Double res = folderRepository.ninethQuery();
		return res;
	}

	public Double tenthQuery() {
		Double res = folderRepository.tenthQuery();
		return res;
	}
}
