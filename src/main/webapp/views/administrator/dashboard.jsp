...
<security:authorize access="hasRole('ADMIN')">	
	...
	<h3><jstl:out value="${forthQuery}" /> </h3> 
	<br>
	...
	<h3><jstl:out value="${fifthQuery}" /> </h3> 
	<br>
	
	<h2>
		<spring:message code="sixthQuery" />
	</h2>
	<h3><jstl:out value="${sixthQuery}" /> </h3> 
	<br>
	...
	<h3><jstl:out value="${eighthQuery}" /> </h3> 
	<br>
	
		
	<h2>
		<spring:message code="ninethQuery" />
	</h2>
	<h3><jstl:out value="${ninethQuery}" /> </h3> 
	<br>
	
		
	<h2>
		<spring:message code="tenthQuery" />
	</h2>
	<h3><jstl:out value="${tenthQuery}" /> </h3> 
	<br>
